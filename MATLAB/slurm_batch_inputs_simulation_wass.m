...
% Init directory
initdir = fullfile('/cluster','shared','dbanco02','simulated_data_fit');

% Output directory
outputdir = fullfile('/cluster','shared','dbanco02','simulated_data_fit_wass_reg');
mkdir(outputdir)

% Function
funcName = 'wrap_wass_reg_FISTA_Circulant';
jobDir1 = fullfile(datadir,['job_simulated_data_wass']);
mkdir(jobDir1)
