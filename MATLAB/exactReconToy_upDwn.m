...
%     D0(:,:,i) = D0(:,:,i)/norm(D0(:,:,i));
% end
D0(1,:,1) = yd(1,1:N0,3) + 50*rand(1,N0,K)/100;

% Show true dictionary
f5 = checkDict_upDwnSample(X_true,yd(1,1:N0,3),opt.numScales);
...
opt.Y0 = zeros(size(X_true));%X_true;
...
% 
% checkDict_upDwnSample(X_true,D0,opt.numScales);
