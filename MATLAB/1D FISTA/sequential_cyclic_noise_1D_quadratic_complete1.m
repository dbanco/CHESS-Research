...
dataset = 'D:\CHESS_data\simulated_two_spot_1D_noise2_10';
num_ims = 10;
rescale = 1;
...
P.num_theta= numel(polar_vector);
P.dtheta = 1;
...
init_dir = ['D:\CHESS_data\noise_1D_Quadratic_10_init' num2str(iii)];
output_dirA = ['D:\CHESS_data\noise_1D_Quadratic_10_' num2str(iii) 'a'];
output_dirB = ['D:\CHESS_data\noise_1D_Quadratic_10_' num2str(iii) 'b'];
    ...
    for image_num = 1:num_ims
        ...
        if jjj == 1
            ...
            if image_num == 1
                ...
                [x_hat, err, ~, ~,  obj, ~] = space_wasserstein_FISTA_Circulant_1D_Quadratic(A0ft_stack,b,vdfs,D,x_init,P.params);
            end
            new_vdf = squeeze(sum(x_hat,1))/sum(x_hat(:));
            vdfs = {new_vdf};
