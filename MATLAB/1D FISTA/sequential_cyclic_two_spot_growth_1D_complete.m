...
gamma_vals = [0.005 0.01 0.02 0.05 0.1 0.2 0.5 1];
dataset = 'D:\CHESS_data\simulated_data_two_spot_growth_1D_25';
num_ims = 25;

for iii = 1:numel(gamma_vals)
    
    init_dir = ['D:\CHESS_data\two_spot_growth_1D_25_init' num2str(iii)];
    output_dirA = ['D:\CHESS_data\two_spot_growth_1D_25_' num2str(iii) 'a'];
    output_dirB = ['D:\CHESS_data\two_spot_growth_1D_25_' num2str(iii) 'b'];
