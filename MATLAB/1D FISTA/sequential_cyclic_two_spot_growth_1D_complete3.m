...
%     init_dir = ['/cluster/shared/dbanco02/two_spot_growth_1D_25_renorm_lam_init' num2str(iii)];
%     output_dirA = ['/cluster/shared/dbanco02/two_spot_growth_1D_25_renorm_lam_' num2str(iii) 'a'];
%     output_dirB = ['/cluster/shared/dbanco02/two_spot_growth_1D_25_renorm_lam_' num2str(iii) 'b'];

    init_dir = ['D:\CHESS_data\two_spot_growth_1D_25_renorm_lam_init' num2str(iii)];
    output_dirA = ['D:\CHESS_data\two_spot_growth_1D_25_renorm_lam_' num2str(iii) 'a'];
    output_dirB = ['D:\CHESS_data\two_spot_growth_1D_25_renorm_lam_' num2str(iii) 'b'];

    mkdir(init_dir)
    mkdir(output_dirA)
    mkdir(output_dirB)
    
    % Different lambdas for each image
    P_array = cell(num_ims,1);
    for image_num = 1:num_ims
        ...
        P.params.lambda = 0.0359*norm(b)/rescale;
        P_array{image_num} = P;
    end
