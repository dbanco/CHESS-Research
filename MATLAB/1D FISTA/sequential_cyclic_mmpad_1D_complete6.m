...
init_dir = ['/cluster/shared/dbanco02/mmpad_1D_init' num2str(iii)];
output_dirA = ['/cluster/shared/dbanco02/mmpad_1D_' num2str(iii) 'a'];
output_dirB = ['/cluster/shared/dbanco02/mmpad_1D_' num2str(iii) 'b'];
