saveDir = 'D:\CHESS_data\simulated_two_spot_1D_gnoise6_osc';
...
theta_stds1 = amp1.*sin(2*pi*f.*t) + b + amp2.*sin(2*pi*2*t);
theta_stds2 = amp1.*sin(2*pi*f.*t) + b + amp2.*sin(2*pi*2*t);
