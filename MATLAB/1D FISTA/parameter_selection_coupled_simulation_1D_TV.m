...
%     output_dir = ['gnoise4_nonorm_coupled_TV1/simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_coupled'];
    ...
    init_dir = [datadir,'gnoise4_subdir\simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_simul_init'];
    output_dir = ['gnoise4_nonorm_coupled_TV2\simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_coupled'];
