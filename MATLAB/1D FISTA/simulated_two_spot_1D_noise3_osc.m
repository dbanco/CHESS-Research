saveDir = 'D:\CHESS_data\simulated_two_spot_1D_noise3_osc';
...
f = 8;
t = linspace(0,1,100);
theta_stds1 = 3/2*sin(2*pi*f*t) + 10 + 3*sin(2*pi*1.5*t);
theta_stds2 = sin(2*pi*f*t) + 10 + 3*sin(2*pi*1.5*t);

figure(222)
[ha, pos] = tight_subplot(11,10,[.005 .005],[.01 .01],[.01 .01]); 
kk = 1;

noise_std = [0,0.08:0.04:0.52];
