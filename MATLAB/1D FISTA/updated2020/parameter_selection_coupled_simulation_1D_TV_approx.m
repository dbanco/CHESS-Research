...
for n_level = [4,2]
    ...
    indep_dir = ['/cluster/shared/dbanco02/simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_indep_approx/'];
    init_dir = [datadir,'gnoise4_subdir/simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_simul_init'];
    output_dir = ['gnoise4_nonorm_coupled_TV9_approx/simulated_two_spot_1D_',dset_name,'_',num2str(n_level),'_coupled'];
    mkdir([datadir,'gnoise4_nonorm_coupled_TV9_approx'])
