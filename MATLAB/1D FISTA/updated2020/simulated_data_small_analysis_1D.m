...
datasetName = 'two_spot_growth_1D_25_init1';
fitName = '';
...
var_signal = zeros(num_imgs,numel(lambda_vals),P.num_var_t);
...
for lam_num = 1
    for img_num = 1:num_imgs
        ...
        az_spread(k,lam_num) = sum(sqrt(P.var_theta).*az_var_signal)/var_sum;
