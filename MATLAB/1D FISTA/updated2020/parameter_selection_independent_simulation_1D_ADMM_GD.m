...
% out_dir = '/cluster/shared/dbanco02/ADMM_GD_indep1/';
out_dir = 'E:\CHESS_data\ADMM_GD_indep1\';
mkdir(out_dir)
for jjj = 3
...
%     output_dir = [out_dir,'simulated_two_spot_1D_',dset_name,'_',num2str(jjj),'_indep1/'];
    ...
    for image_num = 1:num_ims
        ...
        for ii = 1:N
            ...
            P_local.set = ii;
            [x_hat,err,obj] = convADMM_LASSO_GD_1D(A0ft_stack,bn,x_init,P_local.params);
            try
