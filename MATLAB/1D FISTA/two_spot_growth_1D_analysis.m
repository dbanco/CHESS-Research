...
baseDataset = 'two_spot_growth_1D_25_';
suffix = 'b';
fitName = '1-5';
...
fDir = [baseDir,baseDataset,num2str(1),suffix];
...
for gam_num = 1:numel(gamma_vals)
