...
TVx1 = sum(abs(DiffX_1D(X_hat_tvx)),'all')
TVphi1 = sum(abs(DiffPhiX_1D(X_hat_tvx)),'all')
TVx2 = sum(abs(DiffX_1D(X_hat_tvphi)),'all')
TVphi2 = sum(abs(DiffPhiX_1D(X_hat_tvphi)),'all')
