...
%     [X_hat,err,obj,l1_norm,tv_penalty] = convADMM_LASSO_CG_TVphi_1D(A0ft_stack,B,zeros(N,K,T),P.params);
    [X_hat,err,obj,l1_norm,tv_penalty] = convADMM_LASSO_CG_TVphi_1D(A0ft_stack,B,X_indep_CG,P.params);
...
hold on
% plot(theta_stds1,theta_stds1,'-','Linewidth',2)
plot(theta_stds1,abs(awmv_az_indep-theta_stds1),'Linewidth',1)
plot(theta_stds1,abs(awmv_az_indep_CG-theta_stds1),'Linewidth',1)
plot(theta_stds1,abs(awmv_az-theta_stds1),'Linewidth',1)
xlabel('\sigma')
ylabel('AWMV')
%end
