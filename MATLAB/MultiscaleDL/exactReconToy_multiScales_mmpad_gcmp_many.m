...
% plotDataSeq(y)
scales = cell(3,1);
scales{1} = genRationals([0;1],[1;1],10,100, 1/10);
scales{2} = genRationals([0;1],[1;1],10,100, 1/10);
scales{3} = genRationals([0;1],[1;1],10,100, 1/10);
...
topDir = 'C:\Users\dpqb1\Documents\Outputs\gcmp_multiScales_mmpad_many1\';
dName = sprintf('mmpad');
mkdir(topDir)
% results = struct([]);
