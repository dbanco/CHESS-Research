...
for s_recenter = 1
    ...
    topDir = ['/cluster/home/dbanco02/Outputs_8_26_indep_test_trials_',dataset,'_',opt.Penalty,...
    ...
    j_of_select = selected_lam_of(sig_i);
    j_hs_select = selected_lam_hs(sig_i);

    initDir = ['/cluster/home/dbanco02/Outputs_8_26_indep_trials_',dataset,'_',opt.Penalty,...
