...
for n = 1:NN
    ...
    [lambda_s_sel,j_s] = param_select_lambda_s(inDir,tradeoff_s,scaleP,22,criterion,sigmas(n)+0.003);
...
pptFile = ['C:\Users\dpqb1\Documents\MCDL Paper\recons_9_25_dicts_sim1_discrep5_indep.pptx'];
titleStr = 'Sim 1 Recovery';
