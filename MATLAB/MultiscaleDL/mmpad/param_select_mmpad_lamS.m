...
outDir = 'mmpad_ring1_optFlow_2_1_2024';
...
x_data = circshift(l1_norm,-3);
y_data = circshift(rel_error,-3);
loglog(x_data,y_data,'o-')
xlabel('l1')
ylabel('Err')
...
criterion = x_data/1000 + y_data;

[minCrit, selInd] = min(criterion);

hold on
loglog(x_data(selInd),y_data(selInd),'sr','MarkerSize',10)
