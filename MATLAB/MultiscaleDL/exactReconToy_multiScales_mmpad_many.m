...
% plotDataSeq(y)
scales = cell(3,1);
scales{1} = genRationals([0;1],[1;1],9,100, 1/9);
scales{2} = genRationals([0;1],[1;1],9,100, 1/9);
scales{3} = genRationals([0;1],[1;1],9,100, 1/9);
...
topDir = 'C:\Users\dpqb1\Documents\Outputs\multiScales_mmpad_many2\';
dName = sprintf('mmpad');
mkdir(topDir)
% results = struct([]);
