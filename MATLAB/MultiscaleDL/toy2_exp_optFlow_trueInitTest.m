...
% Directory
topDir = 'C:\Users\dpqb1\Documents\Outputs\toy2_exp_optFlow7_21_Xtrue_Dfixed_Vtrue_HS0.001';
...
opt.Smoothness = 0.001;%1e-6;%opt.Smoothness = 1e-8;
opt. HSiters = 100;

close all
lambdas = [1e-2 10e-2];
lambda2s = [0 1e-3 2e-3 5e-3 1e-2 2e-2 5e-2 0.1 0.2 0.5 1];
%% Dictionary learning
