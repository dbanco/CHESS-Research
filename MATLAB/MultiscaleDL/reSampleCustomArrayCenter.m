function [Dout,NormVals] = reSampleCustomArrayCenter(N,D,scales,center,NormVals)
...
for k = 1:K
    ...
    for i = 1:U
        ...
        if c1 == c2
            ...
            Dk = D(:,:,k);
            Dku = uSample(Dk,c1);
            Dk = dSampleCenter(Dku,c2,c1*center); 
            [Nud1,Nud2,~] = size(Dk);
            Dk = circshift(padarray(Dk,[0,N-Nud2],0,'post'),...
                           center-floor(center*c1/c2)-1);
