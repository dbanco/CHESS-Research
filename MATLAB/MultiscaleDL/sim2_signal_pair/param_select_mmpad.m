...
datasets = {'sim2_gaussian_tooth_matched','sim2_gaussian_tooth_unmatched',...
            ...
            'pseudo-voigt_unmatched','voigt_tooth_matched','mmpad_ring1'};
...
opt.Xfixed = 0;
topDir = ['E:\MCDLOF_processing\Outputs_5_13_K1_',dataset,'_',opt.Penalty,...
...
criterion = 'discrepancy range mmpad';
...
pptFile = ['C:\Users\dpqb1\Documents\MCDL Paper\mmpadK1_lam_s_5_13',...
