...
opt.Xfixed = 0;
topDir = ['E:\MCDLOF_processing\Outputs_4_18_',dataset,'_',opt.Penalty,...
...
for n = sig_ind
    ...
    selected_inds(n) = find(lambda_s_sel == lambdaVals);
end
...
pptFile = ['C:\Users\dpqb1\Documents\MCDL Paper\sim1_lam_s_a1b_',criterion,'_',dirStartS,'.pptx'];
