...
topDir = ['E:\MCDLOF_processing\Outputs_5_29of_',dataset,'_',opt.Penalty,...
    '_D',opt.dictInit,num2str(opt.Dfixed),...
    '_X',opt.coefInit,num2str(opt.Xfixed),...
    '_recenter',num2str(0)];

topDir2 = ['E:\MCDLOF_processing\Outputs_5_29_',dataset,'_',opt.Penalty,...
    '_D',opt.dictInit,num2str(opt.Dfixed),...
    '_X',opt.coefInit,num2str(opt.Xfixed),...
...
%% Compute errors
dirStartS = 'results';
selected_lam_all_vec2 = [0,0,0;36,1,1;47,1,1;54,1,1;58,1,1;64,1,1];
...
pptFile = ['C:\Users\dpqb1\Documents\MCDL Paper\sim2_lam_of_5_13',...
