...
for s_recenter = 1
    ...
    topDir = ['/cluster/home/dbanco02/Outputs_8_22_of_',dataset,'_',opt.Penalty,...
        '_D',opt.dictInit,num2str(opt.Dfixed),...
        '_X',opt.coefInit,num2str(opt.Xfixed),...
        '_recenter',num2str(opt.Recenter),'/results_trial_',num2str(trial)];
        
    selected_lam_s_inds = [0,0,0,0,0,0];

        % --- Noise level, regularization parameters ---
        for sig_i = sig_ind
        j_s_select = selected_lam_s_inds(sig_i);
        
        initDir = ['/cluster/home/dbanco02/Outputs_8_22_indep_',dataset,'_',opt.Penalty,...
