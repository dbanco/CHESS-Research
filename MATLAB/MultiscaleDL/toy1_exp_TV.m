...
% Directory
topDir = 'C:\Users\dpqb1\Documents\Outputs\toy1_exp_TV15';
% mkdir(topDir)
...
close all
lambda2s = [8e-2 10e-2 12e-2 14e-2 16e-2];
%% Dictionary learning
...
%     for j = 18 %1:numel(lambdas)
    for j = 1:5
        % Solve
        lambda = 0.23;
        [D, X, optinf, obj, relErr] = cbpdndl_cg_TVphi_multiScales(D0, y, 0.23,lambda2s(j), opt, scales);
