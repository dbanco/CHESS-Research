function sim_mcdlof_wrapper2(lambdaVals,lambdaOFVals,lambdaHSVals,j_s,j_of,j_hs,sigmas,i,opt,topDir,dataset,K,scales)
...
[D,Y,X,Dmin,Ymin,Uvel,Vvel,~,~,~] = cbpdndl_cg_OF_multiScales_gpu_zpad_centerPenalty(opt.G0, y, lambda,lambda2, opt, scales,Uvel,Vvel);
