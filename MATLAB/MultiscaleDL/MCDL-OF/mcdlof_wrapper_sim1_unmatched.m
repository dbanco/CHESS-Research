function mcdlof_wrapper_sim1_unmatched(lambdaVals,lambdaOFVals,lambdaHSVals,j_s,j_of,j_hs,sigmas,i,opt,K,scales,topDir,dataset)
...
switch dataset
    case 'matched'
        [y,~,N,M,T] = gaus_example_unmatched_multiscale_dl(sigmas(i));
    case 'unmatched'
