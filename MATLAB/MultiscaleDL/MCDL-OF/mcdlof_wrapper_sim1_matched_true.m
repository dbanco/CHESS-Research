function mcdlof_wrapper_sim1_matched_true(lambdaVals,lambdaOFVals,lambdaHSVals,j_s,j_of,j_hs,sigmas,i,opt,K,scales,topDir)
...
% Data  
[y,~,N,M,T,Xtrue,Dtrue] = gaus_example_matched_multiscale_dl(sigmas(i));
y = reshape(y,[1,N,T]);
center = (M+1)/2;
