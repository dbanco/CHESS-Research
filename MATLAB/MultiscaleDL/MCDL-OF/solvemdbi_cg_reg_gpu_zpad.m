function [x, cgst] = solvemdbi_cg_reg_gpu_zpad(a,rho,b,tol,mit,isn,N,M,K,J,T,lambda2,useGpu)

% solvemdbi_cg_reg -- Solve a multiple diagonal block linear system with a
