function [yn,y,K,J,N,M,T,Xtrue,Dtrue,scales] = gaus_linear_osc_signal_matched_small(sigma)
...
minPos2 = -5;
amp = 15;
shift = 4*pi/50*20/pFactor;
Pos  = mod(round( amp*sin( 4*pi/50*((1:T)+20)/pFactor + pi/2 )      + amp + minPos1),N);
Pos2 =     round( amp*sin( 4*pi/50*((1:T)+20)/pFactor + pi + pi/2 ) + amp + minPos2);
