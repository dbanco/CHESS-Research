...
% Directory
topDir = 'C:\Users\dpqb1\Documents\Outputs\toy2_exp_optFlow7_25_X0_Dfixed_indep';
...
opt.Smoothness = 0;%1e-6;%opt.Smoothness = 1e-8;
opt. HSiters = 100;

close all
lambdas = [5e-4 1e-3 2e-3 5e-3 1e-2 2e-2 5e-2 0.1 0.2 0.5 1 2 5 10 20];
%% Dictionary learning
