function B = gaussian_basis_wrap_3D_norm(num_theta,dtheta,mean_theta,var_theta,...
...
idx = 1:num_omega;
opposite = (idx(wrapN(mean_rad-floor(num_omega/2),num_omega)+1) +...
            idx(wrapN(mean_rad-ceil(num_omega/2),num_omega)+1))/2;
