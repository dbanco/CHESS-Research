...
weightdir = fullfile('/cluster','shared','dbanco02','mmpad_ring1_zero_fit_weights');

% Output directory
outputdir = fullfile('/cluster','shared','dbanco02',['mmpad_',ringName,'_fit_wass_reg_weighted']);
mkdir(outputdir)

% Function
funcName1 = 'wrap_wass_weighted_reg_FISTA_Circulant';
jobDir1 = fullfile(datadir,['job_mmpad_',ringName,'_wass_weighted']);
mkdir(jobDir1)
...
for img = img_nums
    P.img = img;
    P.set = ring_num;
    varin = {initdir,weightdir,P,outputdir};
    funcName = funcName1;
