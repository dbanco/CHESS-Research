...
% Last Modified by GUIDE v2.5 18-Sep-2017 14:26:54
...
for i = 1:5
    ...
    imshow(squeeze(high_var_theta(i,handles.r1:handles.rend,:)-center),'DisplayRange',...
...
for i = 1:5
    eval(sprintf('axes(handles.axes%i)',i))
    imshow(squeeze(high_var_rad(i,handles.r1:handles.rend,:)-center),'DisplayRange',...
           [handles.min_limit handles.max_limit],'Colormap',jet)
    title(sprintf('Load %i',i))
end
colorbar()
