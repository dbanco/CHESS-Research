...
% Output directory
outputdir = fullfile('/cluster','shared','dbanco02','fit_synth2_norm2_reg2');
mkdir(outputdir)

% Function
funcName1 = 'wrap_norm2_FISTA_Circulant';
funcName2 = 'wrap_space_awmv_FISTA_Circulant';
jobDir1 = fullfile(datadir,'job_al7075_311_synth2_reg2_init');
jobDir2 = fullfile(datadir,'job_al7075_311_synth2_reg2');
mkdir(jobDir1)
mkdir(jobDir2)
